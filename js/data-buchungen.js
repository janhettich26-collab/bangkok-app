...
const BOOKINGS = [
  ...
  { id:"elefanten", kurz:"Elefanten-Park", grp:"Termine", status:"fix", emoji:"🐘", date:"2026-09-01", time:"9:00–12:00",
    ...
    info:["<b>✅ GEBUCHT am 21.08.2026 über GetYourGuide</b> — 53,42 €, ohne Transfer, 1 Erwachsener, Di 01.09. um 9:00. Das Ticket liegt als QR-Code im Apple Wallet, die Buchungsnummer steht dort.",
          "<b>Kostenlose Stornierung bis Mo 31.08., 9:00 Uhr</b> — bis dahin kommst du ohne Kosten wieder raus.",
          "<b>Am Tag selbst:</b> um 9:00 am Treffpunkt sein und den QR-Code aus dem Wallet zeigen. Auf dem Ticket steht als Code „BES-Meeting Point“ — das ist der Sammelpunkt, nicht der Parkeingang.",
          "<b>ZUM ENGLISCH — das ist kein Problem hier:</b> Buch über <b>GetYourGuide auf Deutsch</b> (Button unten), nicht direkt beim Park. Dann ist die ganze Buchung, die Bestätigung und der Kundendienst auf Deutsch, und du kannst bis 24 Std. vorher kostenlos stornieren. Beim Park selbst läuft alles auf Englisch.","<b>Vor Ort brauchst du fast keine Sprache:</b> Das Programm ist zum Mitmachen, nicht zum Zuhören — füttern, laufen, Schlamm, baden. Der Guide macht alles vor, du machst nach, wie alle anderen auch. Für den Rest liegen im Reiter <b>Sprache → 🐘 Elefanten-Park</b> elf Sätze mit Aussprache bereit, einer davon: „My English is not good. Can you show me, please?“ — das sagst du einmal und der Guide zeigt dir alles.","Ethisch: kein Reiten, keine Shows. 4,8 ★ bei über 1.000 Bewertungen","Park täglich 9–17 Uhr offen · Option OHNE Transfer buchen, du fährst selbst mit Bolt","Ablauf: 9:00 Welcome Drink · 9:15 Elefantenkunde · 9:30 Kräuterinhalator basteln · 9:45 füttern · 10:05 Waldspaziergang, Schlamm-Spa, baden · 11:15 duschen & umziehen · 11:30 Thai-Lunchbox","Outfit, Hut und Handtuch stellt der Park — du brauchst nur Badehose und trockene Wechselsachen für die Heimfahrt","Anfahrt: ~50 km vom Hotel, 1–1,5 Std. mit Bolt (600–900 ฿). Dienstag ist Berufsverkehr → 7:00 losfahren","<b>DEM FAHRER DAS HIER ZEIGEN:</b><br><span class=\"thai-adr\">ฮาราจูกุ ไทยแลนด์ ถ.สุวินทวงศ์ แขวงกระทุ่มราย เขตหนองจอก กรุงเทพมหานคร 10530</span><br>Das ist der Treffpunkt „Harajuku Thailand“ an der Suwinthawong Road, wie ihn GetYourGuide angibt","<b>Der Sammel-Transfer fährt Nonthaburi NICHT an</b> — der Park hat den Abholservice zum 12.10.2024 unter anderem für Nonthaburi eingestellt. Es gäbe nur einen privaten Transfer für 1.800 ฿ extra, direkt an den Fahrer. Ohne Transfer zu buchen und selbst mit Bolt zu fahren war also die einzig sinnvolle Wahl","Preise vergleichen: direkt beim Park 1.900–2.200 ฿, auf Klook und GetYourGuide oft günstiger — beide haben deutsche Seiten mit deutschem Kundendienst","Google Übersetzer vorher aufs Handy: Thai und Englisch als Offline-Paket laden. Die Kamera-Funktion übersetzt Schilder und Speisekarten live","Park-Telefon: +66 90 920 5885"],
  ...
  { id:"healthland", nachricht:{ en:"Hello! I would like to book a massage at Health Land Asoke for Tuesday, 1 September 2026, at 1:30 pm. One person, aroma oil massage, two hours. My name is Jan Hettich.\n\nMy English is not very good — please speak slowly. Thank you!", de:"Hallo! Ich möchte eine Massage im Health Land Asoke buchen, für Dienstag, 1. September 2026, um 13:30 Uhr. Eine Person, Aroma-Öl-Massage, zwei Stunden. Mein Name ist Jan Hettich.\n\nMein Englisch ist nicht gut — bitte sprechen Sie langsam. Danke!" }, tun:"anrufen", kurz:"Health Land Asoke", grp:"Termine", status:"offen", emoji:"💆", date:"2026-09-01", time:"13:30",
  ...
  { id:"cruise", klook:"https://www.klook.com/de/destination/c4-bangkok/1010-cruises/", kurz:"Dinner-Cruise", grp:"Termine", status:"offen", emoji:"🛳️", date:"2026-09-03", time:"18:00–20:00",
    title:"Chao-Phraya Dinner-Cruise (5 Sterne)", where:"Ablegen an Asiatique The Riverfront",
    price:"Auf Klook aktuell 36–44 € für die 5-Sterne-Schiffe mit Buffet — die ganz billigen Angebote sind kleinere Boote",
    info:["<b>Früheste Abfahrt nehmen, die es gibt.</b> Viele Schiffe starten erst 19:30/20:00 — ein 18-Uhr-Slot ist die Ausnahme. Sonnenuntergang ist um 18:28, danach fährst du durch die beleuchtete Stadt","Vorbei an Wat Arun, Grand Palace und ICONSIAM vom Wasser aus","17:15 Bolt ab Hotel (40 Min, 260–340 ฿), Check-in am Asiatique Pier","Ohne Alkohol völlig unproblematisch — Dinner-Buffet und Säfte sind dabei","Danach noch eine Runde Asiatique-Nachtmarkt"],
  ...
  { id:"mahanakhon", klook:"https://www.klook.com/de/activity/16870-king-power-mahanakhon-skywalk-ticket-bangkok/", kurz:"Mahanakhon SkyWalk", grp:"Termine", status:"offen", emoji:"🏙️", date:"2026-09-02", time:"17:15–19:00",
    ...
    price:"Über Klook rund 800 ฿ (~20 €) · am Tor 1.080–1.200 ฿ zum Sonnenuntergang, 880–1.000 ฿ tagsüber",
  ...
  { id:"schiessstand", klook:"https://www.klook.com/de/search/?query=Bangkok%20Shooting%20Range", kurz:"Schießstand", grp:"Vor Ort", status:"vorort", emoji:"🎯", date:"2026-08-31", time:"9:00–10:30",
    title:"Schießstand Bangkok — für Touristen legal", where:"1019/7 Phahonyothin Rd, Phaya Thai (Ari) · BTS Ari, 5 Min zu Fuß",
    price:"Glock 9 mm, 30 Schuss ~1.700 ฿ (~45 €) · M16 mit Schalldämpfer, 20 Schuss 2.500 ฿",
    info:["Am Vorabend online buchen: der Stand empfiehlt mindestens 2 Std. Vorlauf und gibt Online-Rabatt. Offen 9–17 Uhr, letzte Buchung 16:30, gezahlt wird bar in Baht","Für Touristen in Thailand legal — der Stand stellt Waffe, Munition, Gehör- und Augenschutz und die Aufsicht","Täglich 9–17 Uhr, Anmeldung nicht nötig. Einfach hingehen, Pass mitnehmen. Tel. +66 82 494 1179","Sprache ist kein Thema: Der Aufseher zeigt jeden Handgriff vor, du machst nach","Alternative in Lat Phrao (Ratchasawas Mongkol, Di–So 10–18): 1.990 ฿ mit Einzelcoaching und Urkunde zum Mitnehmen","Über GetYourGuide auch auf Deutsch buchbar — dort „Shooting Range Experience“","Danach mit Bolt weiter in die Altstadt zum Grand Palace, rund 25 Minuten"],
  ...
  { id:"gokart", nachricht:{ en:"Hello! I would like to come for go-karting on Friday, 4 September 2026, at about 7:30 pm. One person, Fast Kart, two races. Is the track open for walk-in customers at that time, or is it reserved for a group? My English is not very good, please write simple. Thank you!", de:"Hallo! Ich möchte am Freitag, 4. September 2026, gegen 19:30 Uhr Kart fahren kommen. Eine Person, Fast Kart, zwei Rennen. Ist die Bahn zu der Zeit für Laufkundschaft offen oder für eine Gruppe reserviert? Mein Englisch ist nicht gut, bitte einfach schreiben. Danke!" }, klook:"https://www.klook.com/de/destination/c4-bangkok/1031-go-karting/", kurz:"Go-Kart EasyKart", grp:"Vor Ort", status:"vorort", emoji:"🏎️", date:"2026-09-04", time:"19:30",
    title:"EasyKart — große Indoor-Kartbahn im RCA", where:"RCA Plaza, 2. Stock, Rama 9 Rd · MRT Phra Ram 9",
    price:"Klook ab ~18 € · vor Ort Fast Kart 1.499 ฿ für 2 Rennen, Regular 699 ฿, 3 Rennen + T-Shirt 1.999 ฿",
  ...
  { id:"palast", grp:"Vor Ort", status:"vorort", emoji:"👑", date:"2026-08-31", time:"10:00",
    ...
    info:["<b>Hin mit dem Auto, zurück mit dem Boot</b> — so steht es im Plan: 11:00 Bolt in die Altstadt (25 Min, 200–260 ฿), abends ab Tha Tien mit dem Expressboot flussaufwärts nach Nonthaburi (~1 Std., orange 18 ฿, gelb 23 ฿, rot 32 ฿, an Bord zahlen). <b>Das letzte Boot nordwärts geht gegen 18:10</b> — um 17:00 am Pier sein","Dresscode am Palast ist der strengste des Landes: lange Hose, Oberteil MIT Ärmeln, geschlossene Schuhe oder Sandalen mit Fersenriemen. Shorts, ärmellos, zerrissene Jeans, Flip-Flops = abgewiesen. Sarong-Verleih am Eingang gegen ~200 ฿ Pfand","Kassenschluss Palast 15:30, Gelände bis 16:30 — vormittags hin. Das 500-฿-Ticket gilt 7 Tage und deckt Wat Phra Kaew und das Queen-Sirikit-Textilmuseum mit ab","Wat Pho (8–18:30): liegender Buddha, Wasserflasche im Ticket, dazu Thai-Massage in der Original-Tempelmassageschule — 30 Min ab 340 ฿, 1 Std. ~520 ฿"],
  ...
  { id:"ayutthaya", grp:"Vor Ort", status:"vorort", emoji:"🏛️", date:"2026-09-04", time:"9:05",
    ...
    price:"Zug 3. Klasse 20–70 ฿ je Strecke · Sammelticket Ruinen 220 ฿ · Roller ~250 ฿",
