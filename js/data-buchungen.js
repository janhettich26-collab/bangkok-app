...
const BOOKINGS = [
  ...
  { id:"elefanten", nachricht:{ en:"Hello! I would like to book the Half Day Morning Program WITHOUT transfer for Tuesday, 1 September 2026, 9:00 am. One adult. My name is Jan Hettich, from Germany.\n\nMy English is not very good, so please write in simple words. Could you tell me the price, how to pay, and whether I should bring anything besides swimwear and a change of clothes?\n\nI will come by taxi from Nonthaburi. Thank you!", de:"Hallo! Ich möchte das Halbtags-Vormittagsprogramm OHNE Transfer für Dienstag, 1. September 2026, 9:00 Uhr buchen. Ein Erwachsener. Mein Name ist Jan Hettich aus Deutschland.\n\nMein Englisch ist nicht gut, bitte schreiben Sie einfach. Können Sie mir Preis und Zahlungsweg sagen — und ob ich außer Badehose und Wechselsachen noch etwas mitbringen soll?\n\nIch komme mit dem Taxi aus Nonthaburi. Danke!", wa:"66909205885" }, klook:"https://www.klook.com/de/activity/122165-bangkok-elephant-care-program-at-bangkok-elephant-park/", kurz:"Elefanten-Park", grp:"Termine", status:"offen", emoji:"🐘", date:"2026-09-01", time:"9:00–12:00",
  ...
  { id:"cruise", klook:"https://www.klook.com/de/destination/c4-bangkok/1010-cruises/", kurz:"Dinner-Cruise", grp:"Termine", status:"offen", emoji:"🛳️", date:"2026-09-03", time:"18:00–20:00",
    ...
    price:"Klook ab ~19 € · mit Dinner-Buffet 23–43 €, dort mehrere Schiffe zur Auswahl",
  ...
  { id:"sharkdive", nachricht:{ en:"Hello! I would like to book the Shark Dive for Thursday, 3 September 2026, at 11:00 am (or the closest available time). One person, no diving experience, no licence. My name is Jan Hettich, from Germany.\n\nImportant: my English is not very good. Your booking conditions say that divers who do not speak fluent English should contact you in advance so a translation can be arranged for the briefing — could you please do that for me?\n\nPlease let me know the price, how I pay, and what I need to bring. Thank you very much!", de:"Hallo! Ich möchte den Shark Dive für Donnerstag, 3. September 2026, um 11:00 Uhr buchen (oder die nächstmögliche Zeit). Eine Person, keine Taucherfahrung, kein Schein. Mein Name ist Jan Hettich aus Deutschland.\n\nWichtig: Mein Englisch ist nicht gut. In Ihren Bedingungen steht, dass Taucher ohne fließendes Englisch sich vorher melden sollen, damit eine Übersetzung für die Einweisung organisiert wird — könnten Sie das bitte für mich machen?\n\nBitte sagen Sie mir Preis, Zahlungsweg und was ich mitbringen muss. Vielen Dank!", wa:"66812744637" }, klook:"https://www.klook.com/de/search/?query=SEA%20LIFE%20Bangkok", kurz:"Shark Dive", tun:"buchen (LINE/WhatsApp)", grp:"Termine", status:"offen", emoji:"🦈", date:"2026-09-03", time:"11:00",
