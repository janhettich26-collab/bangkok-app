...
const PLAN = [
  ...
  { date:"2026-08-28", wd:"Fr", title:"Ankommen & großer Nachtmarkt", icon:"🌃",
    blocks:[
      ...
      { t:"~15:15", txt:"Transfer zum Hotel (in deiner Buchung inklusive — Abholzeit hast du 24 h vorher gecheckt). Freitagnachmittag ist Rushhour, rechne mit 1–1,5 Std.", z:"hotel" },
      ...
      { t:"18:30", txt:"Los: MRT ab Yaek Tiwanon → Tao Poon → Thailand Cultural Centre, Ausgang 4 (~45 Min). Purple und Blue zusammen kosten 50–71 ฿, am Automat wird der Preis für deine Strecke berechnet. Oder Bolt in 30 Min für 200–260 ฿, wenn du platt bist.", z:"joddfairs" },
  ...
  { date:"2026-08-29", wd:"Sa", title:"Chatuchak & Chinatown", icon:"🧺",
    blocks:[
      { t:"8:45", txt:"MRT ab Yaek Tiwanon → Tao Poon → Chatuchak Park (~35 Min, 40–60 ฿ für Purple + Blue). Heute läuft der Markt komplett — alle 27 Sektionen, 15.000 Stände.", z:"chatuchak" },
      ...
      { t:"17:00", txt:"Los nach Chinatown: MRT ab Yaek Tiwanon, in Tao Poon auf die Blue Line, bis Wat Mangkon, Ausgang 1 — ~50 Min, 50–71 ฿. Mit dem Auto wäre es zur Essenszeit deutlich langsamer.", z:"chinatown" },
  ...
  { date:"2026-08-30", wd:"So", title:"Spa, Riesenmall & Golden Mount", icon:"🧖",
    blocks:[
      { t:"8:30", txt:"Bolt zum Mandarin Oriental Hotel (Stadtseite, ~40–45 Min, 250–330 ฿) — Sonntagvormittag ist wenig Verkehr. Dem Fahrer: „Mandarin Oriental Hotel, Oriental Avenue“.", z:"oriental" },
      ...
      { t:"13:00", txt:"ICONSIAM ist nur 750 m zu Fuß — die Riesenmall am Fluss, täglich 10–22 Uhr. Erst essen: Sook Siam im Erdgeschoss, ein nachgebauter schwimmender Markt mit Ständen aus allen 77 Provinzen.", z:"iconsiam" },
      ...
      { t:"17:15", txt:"Bolt zum Golden Mount (~25 Min): 340 Stufen hoch, Eintritt ~100 ฿. Um 17:45 oben stehen — Abendlicht über der Altstadt, die Sonne geht um 18:31 unter.", z:"goldenmount" },
      { t:"19:15", txt:"Abendessen in der Altstadt: Thipsamai Pad Thai in der Mahachai Road ist 10 Min entfernt, der berühmteste Pad Thai der Stadt (80–150 ฿, im Eierteig gewickelt). Öffnungszeit vorher kurz in Maps prüfen — und die Schlange ist nach 21 Uhr am kürzesten.", z:"thipsamai" },
      { t:"20:45", txt:"Zehn Minuten weiter der Pak Khlong Talat, Thailands größter Blumenmarkt — rund um die Uhr offen, Eintritt frei. Berge von Orchideen, Jasmin und Ringelblumen, dazwischen Frauen, die in Sekunden Girlanden für die Tempel flechten. Eine halbe Stunde reicht, und es ist der schönste Abschluss, den der Abend haben kann.", z:"blumenmarkt" },
  ...
  { date:"2026-08-31", wd:"Mo", title:"Schießstand & Paläste", icon:"🎯",
    blocks:[
      { t:"8:30", txt:"Bolt nach Ari zum Schießstand (20–25 Min, 150–200 ฿), 1019/7 Phahonyothin Rd. Öffnet um 9 Uhr, Anmeldung braucht es nicht — Pass mitnehmen.", z:"schiessstand" },
      ...
      { t:"11:00", txt:"Bolt in die Altstadt (~25 Min, 200–260 ฿) — heute andersherum als geplant: hin mit dem Auto, zurück mit dem Boot.", z:"grandpalace" },
      ...
      { t:"17:00", txt:"Zurück per Expressboot flussaufwärts bis Nonthaburi Pier (orange Flagge 18 ฿, ~1 Std.) — die schönste Heimfahrt der Stadt, mit der tiefstehenden Sonne über dem Wasser. Fahren nur bis 19 Uhr, also nicht trödeln.", z:"nonthaburipier" },
  ...
  { date:"2026-09-01", wd:"Di", title:"Elefanten, Massage & Sukhumvit", icon:"🐘",
    blocks:[
      { t:"7:00", txt:"Bolt zum Bangkok Elephant Park, 47 Suwinthawong Rd, Nong Chok (Ostrand Bangkok, ~50 km, 600–900 ฿). Dienstag ist Berufsverkehr — 2 Std. Puffer für 9 Uhr Check-in.", z:"elefanten" },
      ...
      { t:"12:15", txt:"Bolt NICHT heim, sondern direkt nach Sukhumvit (~40–50 Min, 400–600 ฿) — Asoke liegt auf dem Rückweg, das spart dir 1,5 Std. Doppelfahrt. Rückweg ist dort dünn: Fahrer warten lassen oder Park-Rezeption rufen lassen (+66 90 920 5885).", z:"healthasoke" },
      ...
      { t:"16:00", txt:"Terminal 21 ist direkt nebenan: Pier-21-Foodcourt im 5. Stock, Gerichte ab 50 ฿ — der Preis-Leistungs-König.", z:"terminal21" },
  ...
  { date:"2026-09-02", wd:"Mi", title:"Riesenbuddha & Glasboden", icon:"🛕",
    blocks:[
      { t:"9:00", txt:"Los: MRT ab Yaek Tiwanon bis Tao Poon, dort auf die Blue Line und durchgehend bis Bang Phai. Nur ein Umstieg, rund 45 Min.", z:"watpaknam" },
      ...
      { t:"17:15", txt:"Zum Mahanakhon: MRT bis Si Lom, umsteigen auf die BTS Sala Daeng, eine Station bis Chong Nonsi. Der Turm steht direkt über dem Ausgang.", z:"mahanakhon" },
  ...
  { date:"2026-09-03", wd:"Do", title:"Shoppen & Sunset-Cruise", icon:"🛒",
    blocks:[
      ...
      { t:"12:15", txt:"Los in die Shopping-Meile: MRT Purple bis Tao Poon → Blue bis Si Lom → BTS Sala Daeng → 2 Stationen bis Siam (~60 Min; MRT 50–71 ฿ plus BTS 17–65 ฿, die Systeme rechnen getrennt ab). Mit Bolt 45–60 Min für 250–330 ฿.", z:"siam" },
      ...
      { t:"16:45", txt:"Weiter zur Cruise: BTS ab Siam (Silom Line) bis Saphan Taksin, dann Shuttle-Boot ab Sathorn Pier zum Asiatique — zusammen ~40 Min und entspannter als durch den Feierabendverkehr.", z:"asiatique" },
  ...
  { date:"2026-09-04", wd:"Fr", title:"Ayutthaya auf eigene Faust", icon:"🏛️",
    blocks:[
      { t:"7:15", txt:"MRT bis Krung Thep Aphiwat (Bang Sue) — die Blue Line hält direkt darunter. Ticket am Schalter kaufen, es gibt keinen Online-Verkauf für die günstigen Klassen.", z:"bangsue" },
      ...
      { t:"19:30", txt:"GO-KART bei EasyKart im RCA Plaza (MRT Phra Ram 9, ~20 Min ab Bang Sue): Asiens größte Indoor-Kartbahn. Fast Kart mit 200 cm³ und 55 km/h, 1.499 ฿ für zwei Rennen à 8 Minuten. Kein Führerschein nötig, freitags bis 23 Uhr offen. Vorher kurz anrufen (+66 2 641 4252), die Bahn wird manchmal für Gruppen reserviert.", z:"easykart" },
      { t:"21:00", txt:"5 Minuten weiter der Train Night Market Ratchada: der Regenbogen-Zeltmarkt, seit März 2026 wieder offen — Vintage, Container-Bars, Livebands, bis 1 Uhr. Abendessen zwischen den Zelten.", z:"trainmarket" }
    ],
  ...
  { date:"2026-09-05", wd:"Sa", title:"Ancient City & Abschiedsabend", icon:"🛕",
    blocks:[
      { t:"8:00", txt:"Bolt nach Samut Prakan zum Ancient City (45–60 Min, 400–500 ฿). Morgens ist die Strecke frei, und im Park ist es vor Mittag deutlich angenehmer.", z:"ancientcity" },
      ...
      { t:"14:15", txt:"Optional 5 Min weiter: Erawan-Museum — ein 43 Meter hoher dreiköpfiger Elefant aus Kupfer, in den man hineinsteigen kann. Innen Glasfenster und Treppen wie in einer anderen Welt.", z:"erawan" },
  ...
  { date:"2026-09-06", wd:"So", title:"Ko Kret & Rückflug", icon:"🚲",
    blocks:[
      ...
      { t:"9:30", txt:"Bolt nach Wat Sanam Nuea (20–25 Min, 120–150 ฿) — dem Fahrer einfach „Ko Kret“ sagen, das kennt jeder. Am Tempel durchlaufen bis zum Pier, Fähre 3 ฿, eine Minute über den Fluss.", z:"kokret" },
      ...
      { t:"15:30", txt:"Letzte Runde vor der Tür: Health Land Chaeng Wattana für eine Abschiedsmassage (2 Std. Thai 700 ฿) oder Hähnchen-Reis gegenüber, Big C für Mitbringsel.", z:"healthchaeng" },
      { t:"~19:00", txt:"Transfer zum Flughafen (inklusive — Abholzeit hast du 24 h vorher in „Meine Buchung verwalten“ nachgesehen). 3 Std. Puffer.", z:"bkk" },
