...
const PLAN = [
  { date:"2026-08-27", wd:"Do", title:"Abflug München", icon:"🛫",
    blocks:[
      ...
      { t:"~18:45", txt:"Parkplatz anfahren (gebucht, überdacht), Shuttle zum Terminal 2 — fährt etwa alle 10 Min. Ab 16:30 daheim losfahren, Donnerstag-Feierabendverkehr." },
  ...
  { date:"2026-08-28", wd:"Fr", title:"Ankommen & großer Nachtmarkt", icon:"🌃",
    blocks:[
      ...
      { t:"~22:30", txt:"Zurück mit der MRT. <b>Achtung, die Bahn fährt NICHT bis Mitternacht:</b> der letzte Zug der lila Linie ab Tao Poon nach Hause geht um <b>23:35</b>. Von Thailand Cultural Centre brauchst du bis Tao Poon rund 25 Min — also spätestens <b>23:00</b> in die Bahn. Danach nur noch Bolt (~250 ฿)." }
    ],
  ...
  { date:"2026-08-29", wd:"Sa", title:"Chatuchak & Chinatown", icon:"🧺",
    blocks:[
      ...
      { t:"16:45", txt:"Los nach Chinatown. Nimm die Bahn — mit dem Auto wärst du zur Essenszeit deutlich langsamer. Die Fahrt dauert 50 Min, damit bist du kurz vor 17:45 da.", z:"chinatown", r:"🚇 Yaek Tiwanon → Tao Poon → Wat Mangkon, Ausg. 1 · 50 Min · 50–71 ฿" },
      ...
      { t:"~22:00", txt:"MRT zurück ab Wat Mangkon. Von hier sind es <b>35 Min bis Tao Poon</b>, und der letzte lila Zug nach Hause fährt dort um <b>23:35</b> — spätestens <b>22:50</b> einsteigen, sonst wird es ein Bolt (~300 ฿)." }
    ],
  ...
  { date:"2026-08-30", wd:"So", title:"Spa, Riesenmall & Golden Mount", icon:"🧖",
    blocks:[
      ...
      { t:"17:15", txt:"Weiter zum Golden Mount: 344 Stufen hoch, Eintritt 100 ฿, offen bis 19 Uhr. Der Aufstieg dauert mit Fotostopps 15 Min — um 18:00 oben stehen — Abendlicht über der Altstadt, die Sonne geht um 18:31 unter.", z:"goldenmount", r:"🚗 Bolt ab ICONSIAM · 25 Min · ~200 ฿" },
      { t:"19:15", txt:"Abendessen in der Altstadt: Thipsamai Pad Thai in der Mahachai Road ist 10 Min entfernt, der berühmteste Pad Thai der Stadt (80–150 ฿, im Eierteig gewickelt). Geöffnet 9:00–24:00, <b>Ruhetag ist Dienstag</b> — Sonntag passt also. Die Schlange ist nach 21 Uhr am kürzesten.", z:"thipsamai", r:"🚶 10 Min zu Fuß vom Golden Mount" },
      { t:"20:45", txt:"Weiter zum Pak Khlong Talat, Thailands größter Blumenmarkt — rund um die Uhr offen, Eintritt frei. Berge von Orchideen, Jasmin und Ringelblumen, dazwischen Frauen, die in Sekunden Girlanden für die Tempel flechten. Eine halbe Stunde reicht, und es ist der schönste Abschluss, den der Abend haben kann.", z:"blumenmarkt", r:"🚶 1,4 km — 20 Min zu Fuß oder 5 Min Bolt (~60 ฿)" },
      { t:"~21:45", txt:"Bolt zurück, ~250 ฿." }
    ],
    note:"BEI REGEN AB NACHMITTAG: Der Golden Mount sind 344 offene Stufen — bei Guss überspringen und stattdessen länger im ICONSIAM bleiben, dann direkt zum Abendessen in die Altstadt. Eine Anfahrt, vier Sachen: Spa, Mall, Tempel, Essen — alle am selben Flussufer entlang. Chinatown hast du schon gestern gehabt, deshalb heute die Altstadt." },

  { date:"2026-08-31", wd:"Mo", title:"Schießstand & Paläste", icon:"🎯",
    blocks:[
      { t:"8:30", txt:"Los zum Schießstand (offen 9–17 Uhr). <b>Am Vorabend online buchen</b> — der Stand empfiehlt mindestens 2 Std. Vorlauf und gibt auf Online-Buchungen einen Rabatt. Pass mitnehmen, bezahlt wird bar in Baht.", z:"schiessstand", r:"🚗 Bolt nach Ari · 20–25 Min · 150–200 ฿" },
      ...
      { t:"13:30", txt:"Wat Pho, 3 Min zu Fuß: liegender Buddha, 300 ฿, Wasserflasche im Ticket, offen bis 18:30. Dazu Thai-Massage in der Original-Tempelmassageschule — je nach Quelle 340–480 ฿ für 30 Min und 520–680 ฿ für die Stunde; der Aushang an der Kasse gilt." },
      { t:"15:30", txt:"Fähre rüber zum Wat Arun (5 ฿) — Achtung, Eintritt nochmal 200 ฿, offen bis 18 Uhr. Der Foto-Klassiker am Fluss." },
      { t:"17:00", txt:"Zurück per Expressboot — die schönste Heimfahrt der Stadt, mit der tiefstehenden Sonne über dem Wasser. <b>Das orange Boot fährt nur bis etwa 18:10 nordwärts</b>, danach ist Schluss — also wirklich nicht trödeln. Ab Tha Tien (N8) rund 1 Std. bis Nonthaburi.", z:"nonthaburipier", r:"⛴️ Expressboot flussaufwärts · ~1 Std. · 18 ฿ (orange)" },
  ...
  { date:"2026-09-01", wd:"Di", title:"Elefanten, Massage & Sukhumvit", icon:"🐘",
    blocks:[
      ...
      { t:"12:15", txt:"NICHT heim, sondern direkt nach Sukhumvit — Asoke liegt auf dem Rückweg, das spart dir 1,5 Std. Doppelfahrt. Ab Nong Chok ist der Rückweg dünn — dort findet kaum ein Bolt zurück: <b>Fahrer warten lassen</b> (kostet 200–300 ฿ extra, ist es wert) oder im Park nach einem Taxi fragen. Park-Telefon: +66 90 920 5885.", z:"healthasoke", nb:1, r:"🚗 Bolt vom Park nach Asoke · 40–50 Min · 400–600 ฿ · liegt auf dem Rückweg" },
      { t:"13:30–15:30", txt:"Health Land Asoke (vorher anrufen: +66 2 261 1110, tägl. 9–23 Uhr): Thai 2 Std. 650–700 ฿ ODER — nach Sonne, Schlamm und Elefantenlaufen die bessere Wahl — Aroma-Öl 1.200–1.850 ฿ bzw. Ayurveda Abhyanga 1.700 ฿. Bei Öl-Massage duschst du dort vorab." },
  ...
  { date:"2026-09-02", wd:"Mi", title:"Ancient City & Glasboden", icon:"🛕",
    blocks:[
      ...
      { t:"9:30–13:30", txt:"ANCIENT CITY, das größte Freilichtmuseum der Welt: über 100 nachgebaute Tempel, Paläste und Holzhäuser aus ganz Thailand auf 80 Hektar — und fast menschenleer. Fahrrad für ~100 ฿ nehmen und einfach losfahren. Eintritt 700–800 ฿ am Tor, über Klook rund 350 ฿ — <b>vorher online kaufen spart die Hälfte</b>. Park offen 9–19 Uhr, Ticketschalter nur bis 18 Uhr. Die kostenlose Tram fährt 10, 13, 15 und 17 Uhr, das musst du beim Ticketkauf sagen." },
      { t:"13:45", txt:"Optional 5 Min weiter: Erawan-Museum — ein 43 Meter hoher dreiköpfiger Elefant aus Kupfer, in den man hineinsteigen kann. Eintritt 500 ฿, offen 9–18 Uhr, Kasse bis 17 Uhr. Innen Glasfenster und Treppen wie in einer anderen Welt. Und ein Dach über dem Kopf, falls der Nachmittagsschauer kommt.", r:"🚗 5 Min vom Ancient City", z:"erawan" },
      ...
      { t:"17:45–19:00", txt:"MAHANAKHON SKYWALK: Innendeck im 74. Stock, offenes Dach im 78. und der Glasboden auf 310 m. Sonnenuntergang um 18:29 (nachgerechnet). <b>Der Skywalk schließt um 19:00, letzter Einlass 18:30</b> — 17:45 ist also genau richtig. Preis: am Tor <b>1.200 ฿ (~31 €)</b> für den Abend-Slot, <b>über Klook nur rund 800 ฿ (~20 €)</b> — vorher online kaufen spart 400 ฿. Nicht das SkyVerse-Paket erwischen, das ist etwas anderes. Erst kaufen, wenn du am Nachmittag den Himmel gesehen hast." },
  ...
  { date:"2026-09-03", wd:"Do", title:"Shoppen & Sunset-Cruise", icon:"🛒",
    blocks:[
      ...
      { t:"—", txt:"Steuer zurückholen: Ab <b>2.000 ฿ pro Laden und Tag</b> und <b>5.000 ฿ über die ganze Reise</b> geht es. Zurück kommen nicht die vollen 7 %, sondern <b>4–6 %</b> — der Rest sind Gebühren. Pass an der Kasse zeigen, Formular P.P.10 verlangen. <b>Am Flughafen zuerst zum Zoll-Schalter, BEVOR du den Koffer aufgibst</b> — die Ware muss vorgezeigt werden. Erst danach einchecken, und nach der Passkontrolle am VAT-Refund-Schalter das Geld holen." },
      ...
      { t:"18:00–20:00", txt:"5-Sterne-Cruise: Wat Arun, Grand Palace und ICONSIAM vom Wasser, Dinner-Buffet, ohne Alkohol völlig unproblematisch. <b>Achtung beim Buchen:</b> Die meisten Anbieter fahren erst <b>19:30 oder 20:00</b> ab — einen echten 18-Uhr-Slot gibt es nur bei wenigen Schiffen. Nimm die früheste Abfahrt, die du findest; die Sonne ist um 18:28 weg, danach zählen die Lichter." },
  ...
  { date:"2026-09-04", wd:"Fr", title:"Ayutthaya auf eigene Faust", icon:"🏛️",
    blocks:[
      { t:"6:45", txt:"Zum Bahnhof — <b>eine halbe Stunde früher als es sich anfühlt</b>: Fahrt 25 Min, und am Schalter sollst du 20–30 Min vor Abfahrt stehen. Ticket gibt es nur dort, für die günstigen Klassen keinen Online-Verkauf.", z:"bangsue", r:"🚇 MRT bis Krung Thep Aphiwat · Blue Line hält darunter · 25 Min" },
      { t:"7:50 oder 8:45", txt:"Zug nach Ayutthaya (71 km, rund 1 Std.): Rapid 111 um 7:50 oder Express 75 um 8:45 — beide im aktuellen Fahrplan bestätigt. <b>3. Klasse 20–70 ฿</b> (Ventilator, unreserviert), 2. Klasse mit Klimaanlage 245–260 ฿. Fahrplan am Schalter bestätigen lassen — Zeiten verschieben sich in Thailand gern." },
      ...
      { t:"19:30", txt:"GO-KART bei EasyKart, eine der größten Indoor-Kartbahnen Asiens (so wirbt der Betreiber). Fast Kart mit 200 cm³ und 55 km/h, 1.499 ฿ für zwei Rennen à 8 Minuten. Kein Führerschein nötig, freitags 13–23 Uhr offen. Vorher kurz anrufen (+66 2 641 4252) — die Bahn wird manchmal für Gruppen reserviert.", z:"easykart", nb:1, r:"🚇 Blue Line ab Bang Sue bis Phra Ram 9 · 20 Min" },
      { t:"21:00", txt:"Heimfahrt — der Tag war lang genug (seit 6:45 auf den Beinen). Essen gibt es direkt im RCA, danach ab in die Bahn. <b>Nicht länger als bis 22:15 bleiben:</b> ab Phra Ram 9 sind es 30 Min bis Tao Poon, und der letzte lila Zug nach Hause geht dort um 23:35.", r:"🚶 11 Min zu Fuß zur MRT Phra Ram 9 · dann heim · oder Bolt ~250 ฿" }
    ],
    note:"BEI REGEN: Die Ruinen sind komplett im Freien und ohne Unterstand. Wenn morgens Dauerregen gemeldet ist, tausch den Tag mit dem Shopping am Donnerstag — Ayutthaya lohnt nur bei trockenem Wetter. Komplett ~600 ฿ statt 30+ € Tour — und du bist an keine Gruppe gekettet. Abends dann noch Vollgas auf der Kartbahn: Sie liegt an der MRT Phra Ram 9, du kommst aus Ayutthaya direkt dort an. Zwischen Zug (17:20 bzw. 17:56 in Bang Sue) und Kart um 19:30 ist Luft — entweder kurz ins Hotel oder gleich in Ruhe im RCA essen." },
  ...
  { date:"2026-09-05", wd:"Sa", title:"Riesenbuddha & Abschiedsabend", icon:"🛕",
    blocks:[
      ...
      { t:"10:30", txt:"Los zum Wat Paknam — nur ein Umstieg. <b>Aufpassen in Tao Poon:</b> Zug Richtung <b>Tha Phra</b> nehmen, nicht Richtung Lak Song. Beide enden am selben Ring, aber Tha Phra ist der kurze Weg — 10 Stationen statt 23, du sparst 25 Minuten pro Richtung.", r:"🚇 Yaek Tiwanon → Tao Poon → <b>Richtung Tha Phra!</b> → Bang Phai, Ausg. 1 · 40 Min · ein Umstieg", z:"watpaknam" },
      { t:"11:15–13:15", txt:"WAT PAKNAM: Der 69 Meter hohe goldene Buddha ist der höchste Bangkoks — 2021 fertig, komplett aus Bronze, du siehst ihn schon von weitem über die Dächer ragen. Im 80-Meter-Stupa daneben fährst du hoch bis zur smaragdgrünen Glas-Pagode im 5. Stock, darüber eine Decke, die wie eine Galaxie bemalt ist. Eintritt frei, auch der Stupa. Offen 8–18 Uhr; ab der Station Bang Phai sind es 10–15 Min zu Fuß oder 10 ฿ mit dem Motorradtaxi. Und das Beste heute: der halbe Besuch ist drinnen." },
      ...
      { t:"19:00", txt:"Letzter Abend vor der Haustür — heute nichts mehr fahren: Owl Market 10 Min zu Fuß, Big C nebenan für die letzten Mitbringsel, oder Rooftop und Pool im Hotel. (Terminal 21 hattest du am Dienstag.)" },
      { t:"21:30 (optional)", txt:"Sky Bar im Lebua (<b>40 Min Bolt, 250–330 ฿ je Strecke</b> — das Hotel liegt in Nonthaburi, die Bar in Silom), 64. Stock — nur noch, wenn du den Hangover-Rooftop unbedingt gesehen haben willst; den besseren Blick hattest du am Mittwoch: Kein Eintritt, aber ein Getränk pro Person ist Pflicht — Mocktails 600–800 ฿ plus 10 % Service und 7 % Steuer, macht rund 700–950 ฿ für ein alkoholfreies Glas. Offen 17:00–00:30 (letzte Bestellung 00:15), keine Reservierung, nur Stehplätze am runden Bartresen." }
    ],
